...
plot(mean~type, data = by_type_block, xlab = "trial type", ylab = "mean accuracy", main="Accuracy as a function of trial type") 

# boxplot of accuracy as a function of block number
plot(mean~blockNum, data = by_type_block, xlab = "block number", ylab = "mean accuracy", main = "Accuracy as a function of block number") 
...
summary(fit1)
plot(subjectNum~acc, data = by_subject_type)

# nah
ggplot(by_subject_type, aes(acc,type)) +
  geom_point() +
...
##relationship between performance on recap (R1:R4) vs. critical trials
...
##relationship between performance on inner-recap (R2, R3) vs. critical trials
